...
public class TransactionTest {
    public static void main(String[] args) {
        ...
        TransactionDTO obj =
                new TransactionDTO(MakeAccountNumber.makeTrNum(),"20230309101",500,"O","국민카드");
        TransactionDTO obj2 =
                new TransactionDTO(MakeAccountNumber.makeTrNum(),"20230309102",600,"O","국민카드");
        TransactionDTO obj3 =
                new TransactionDTO(MakeAccountNumber.makeTrNum(),"20230309103",700,"O","국민카드");
